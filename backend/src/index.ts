...
const postProcessJq = `{fact: .fact, length: .length}`;
const httpMethod = "GET";
// Defaults to "Content-Type": "application/json"
const headers = "{}";
const queryParams = "{}";
const body = "{}";
const abiSignature = `{"components": [{"internalType": "string", "name": "fact", "type": "string"},{"internalType": "uint256", "name": "length", "type": "uint256"}],"name": "task","type": "tuple"}`;
